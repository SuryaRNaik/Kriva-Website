          ...
          <div className="md:w-1/2 p-10 lg:p-14 flex flex-col justify-center">
            ...
            <form className="space-y-5" onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 rounded-xl text-[#2B2B2B] font-semibold shadow-gold hover:opacity-90 transition-all duration-300 transform active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
