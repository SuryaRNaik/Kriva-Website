  ...
  if (allProducts.length === 0) {
    return (
      <div className="min-h-screen bg-[#FCF4F5] pt-32 pb-12 flex flex-col items-center justify-center">
        <h1 className="text-3xl font-bold text-[#3B2A2C]">Category not found</h1>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <div className="hidden sm:flex items-center gap-6 text-xs text-[#7A6A6D]">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#C9A227]" style={{ fontFamily: "'Playfair Display', serif" }}>{allProducts.length}</div>
